...
# NODE 1 : Indexer
# Function responsible for converting the video to text
def index_video_node(state:VideoAuditState) -> Dict[str,Any]:
    '''
    Downloads the youtube video via the URL provided
...
def audit_content_node(state:VideoAuditState) -> Dict[str,Any]:
    ...
    if not transcript:
        ...
        return{
            "final_status" : "FAIL",
            "final_report" : "Audit Skipped becuase video processing failed (No Transcript.)"
        }
